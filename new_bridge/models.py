...
class WordTable(models.Model):
    title = models.CharField(db_column='TITLE', max_length=25, blank=True) # Field name made lowercase.
    display_lemma = models.CharField(db_column='DISPLAY LEMMA', max_length=90, blank=True, null=True) # Field name made lowercase. Field renamed to remove unsuitable characters.
    english_core = models.CharField(db_column='ENGLISH-CORE', max_length=130, blank=True, null=True) # Field name made lowercase. Field renamed to remove unsuitable characters.
    english_extended = models.CharField(db_column='ENGLISH-EXTENDED', max_length=246, blank=True, null=True) # Field name made lowercase. Field renamed to remove unsuitable characters.
    lasla_morph_1 = models.CharField(db_column='LASLA MORPH 1', max_length=2, blank=True, null=True) # Field name made lowercase. Field renamed to remove unsuitable characters.
    lasla_morph_2 = models.CharField(db_column='LASLA MORPH 2', max_length=1, blank=True, null=True) # Field name made lowercase. Field renamed to remove unsuitable characters.
    lasla_combined = models.CharField(db_column='LASLA Combined', max_length=3, blank=True, null=True) # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    proper = models.CharField(db_column='Proper', max_length=9, blank=True, null=True) # Field name made lowercase.
    part_of_speech = models.CharField(db_column='Part Of Speech', max_length=12, blank=True, null=True) # Field name made lowercase. Field renamed to remove unsuitable characters.
