...
class Command(BaseCommand):
	...
	def add_arguments(self,parser):
		...
		parser.add_argument("text_name",nargs=1, type=str, help="Name of the text")
		...
		if lang=='Latin':
			...
			for item in data_dict:
				try:
					...
					'lnm_definition' : item['LNM-DEFENITION'],
					'aeneid_definition' :  item['AENEID-DEFINITION'],
				    'catullus_definition' : item['CATULLUS-DEFINITION'],
				    'decl' : item['Decl'],
				    'conj' : item['Conj'],
				    'reg_adj_adv' : item['Reg Adj/Adv'] ,
				    'proper' : item['Proper'],
				    'part_of_speech' : item['Part Of Speech'] ,
				    'dcc_frequency_group' : item['DCC FREQUENCY GROUP'] ,
