...
class WordTableGreek(models.Model):
    ...
    accented_lemma = models.CharField(db_column='accented lemma', 
            max_length=50, blank=True, null=True) # Unusitable char.s removed.
    search_lemma = models.CharField(db_column='SEARCH LEMMA', 
            max_length=43, blank=True, null=True) # Made lowercase. Unusitable char.s removed.
    display_lemma = models.CharField(db_column='DISPLAY LEMMA', 
            max_length=175, blank=True, null=True) # Made lowercase. Unusitable char.s removed.
    english_definition = models.CharField(db_column='English Definition', 
            max_length=135, blank=True, null=True) # Made lowercase. Unusitable char.s removed.
    questions = models.IntegerField(db_column='Questions', 
            blank=True, null=True) # Made lowercase.
    decl = models.CharField(db_column='Decl', 
            max_length=4, blank=True, null=True) # Made lowercase.
    idiom = models.IntegerField(db_column='Idiom', 
            blank=True, null=True) # Made lowercase.
    reg_adject_adv_form = models.IntegerField(db_column='Reg Adject/Adv/Form', 
            blank=True, null=True) # Made lowercase. Unusitable char.s removed.
    proper = models.IntegerField(db_column='Proper', 
            blank=True, null=True) # Made lowercase.
