...
# 		        print("All good")
    ...
    if not include_duplicates:
        for lemma_dictionary in list(sections_dictionary.values()):
            for display, location in list(lemma_dictionary.items()):
                final_lemma_dictionary[display].append(location)
    for display, locations in list(final_lemma_dictionary.items()):
